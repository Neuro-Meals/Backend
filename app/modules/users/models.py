...
from sqlalchemy import Boolean, DateTime, Enum as SqlEnum, Integer, String, Float
...
class User(Base):
    ...
    fitness_goal: Mapped[FitnessGoal | None] = mapped_column(SqlEnum(FitnessGoal))
    dietary_preference: Mapped[str | None] = mapped_column(String(255))
    ...
    email_otp: Mapped[str | None] = mapped_column(String(10))
    email_otp_expires_at: Mapped[datetime | None] = mapped_column(DateTime)
